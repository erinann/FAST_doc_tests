...
image:Brackets_commit_1.png[] +
  add a commit message, and click `OK`. +
...
| *Quirks*
a|
* Scrolling in the source pane does not work most of the time
...
a|
* Lots of pop-up boxes when using the GUI to push to a remove repository. It is somewhat annoying to keep clicking `OK`
